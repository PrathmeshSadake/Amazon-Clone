  ...
  return (
    <div className='bg-indigo-50 min-h-screen'>
      <div className='xl:px-20 md:px-10 sm:px-6 px-4 md:py-12 py-9 2xl:mx-auto 2xl:container md:flex items-center justify-center'>
        <div className='md:hidden sm:mb-8 mb-6'>Shintoon</div>
        <div className='bg-white shadow-lg rounded lg:w-2/5 md:w-1/2 w-full lg:px-10 sm:px-6 sm:py-10 px-2 py-6'>
          <p
            tabIndex={0}
        ...
        <div className='xl:w-1/3 md:w-1/2 lg:ml-16 ml-8 md:mt-0 mt-6'>
          ...
          <div className='flex items-start mt-8'>
            ...
            <p className='sm:text-2xl text-xl leading-7 text-gray-600 pl-2.5'>
              OO'SVille is our NFT collection with 25 unique charachters. The
              same charachters in our animation and game. By purchasing our NFTs
              you will be rewarded in our game and in our animations!
            </p>
          </div>
