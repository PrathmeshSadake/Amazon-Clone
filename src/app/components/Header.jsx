        ...
        <div className='py-4 mx-4 md:mx-6'>
          <div className='flex items-center justify-between border-b border-gray-200 dark:border-gray-700 py-4'>
            <div>
              ...
              >
                <img src={amazonLogo} className='w-24 object-contain' alt='' />
              </div>
              <div
                ...
                aria-label='Amazon Logo.'
              >
                <img src={amazonLogo} className='w-20 object-contain' alt='' />
              </div>
              <div
                ...
                aria-label='Amazon Logo.'
              >
                <img src={amazonLogo} className='w-16 object-contain' alt='' />
              </div>
            </div>
        ...
        >
          <div className='w-full'>
            <div className='flex items-center justify-between border-b border-gray-200 dark:border-gray-700 pb-3 mx-4'>
              <div role='img' aria-label='Amazon Logo'>
                <img src={amazonLogo} className='w-16 object-contain' alt='' />
              </div>
              <button
