...
export default function FAQ() {
  return (
    <div className='py-9'>
      <div className='container py-9 mx-auto  flex flex-col items-center justify-center'>
        <div>
          <h1 className='text-center text-3xl sm:text-4xl lg:text-5xl font-bold leading-10 text-black mb-10'>
