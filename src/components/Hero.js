    ...
    <div className=''>
      <div className='flex flex-col lg:flex-row items-stretch justify-between lg:px-0 px-6 lg:py-20 py-8 2xl:mx-auto 2xl:container'>
        <div className='z-30 relative lg:w-1/2'>
          <div className='hidden  w-full lg:w-10/12 lg:h-full lg:flex justify-end items-center'>
            <div className='w-full lg:w-auto lg:-mr-32'>
              <img
                src='https://source.unsplash.com/-tgTipG2t_g'
        ...
        <div className='lg:w-1/2 lg:ml-12 lg:p-14 p-8 flex items-center'>
          <div>
            <h1 className='w-full text-5xl font-semibold text-gray-800 capitalize'>
              SHINTOON ~<span className='text-indigo-600'>OO'SVille</span>
            </h1>
            <p className='md:w-9/12 lg:w-11/12 xl:w-10/12 2xl:9/12 text-base leading-normal text-gray-600 mt-5'>
              Shintoon, an animation company, presenting it's Unique 25
              Characters.
            </p>
